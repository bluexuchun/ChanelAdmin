...
withRouter;
import { quitmethod } from '../store/user.redux';
        ...
        >
            ...
            trigger={
              ...
              >
                <IceImg
                  height={40}
                  width={40}
                  src="https://lem.chanel.com.cn/upload/images/201808/1533882647834.jpg"
          ...
          >
            <ul>
              ...
              <li className="user-profile-menu-item">
                <Link to="Login"  onClick={this.clickQuit.bind(this)}>
