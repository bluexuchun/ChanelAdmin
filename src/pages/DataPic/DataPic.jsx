...
export default class DataPic extends Component {
  static displayName = 'DataPic';
  ...
  componentWillMount() {
    ...
    ajaxTo('api.php?entry=sys&c=group&a=group&do=dataView',{gid:id})
    .then(function(res){
      console.log(res);
      that.setState({
        data:res.data
    ...
    return (
      <IceContainer title="数据图表">
        ...
        <div style={styles.coreDataChartWrapper}>
          <Chart onPlotClick={this.onPlotClick} padding={[40, 40, 40, 40]} background={{backgroundColor:'#000'}}  height={300} data={dv} forceFit>
            <Axis name="天数" />
            <Axis name="分数" />
