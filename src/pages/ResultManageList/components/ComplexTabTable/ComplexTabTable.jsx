...
export default class ComplexTabTable extends Component {
  ...
  componentWillMount() {
    // const that = this;
    // const result = ajaxTo('api.php?entry=sys&c=stage&a=stage&do=list');
        ...
        <IcePanel style={{
          ...
          <IcePanel.Body>
            <Table dataSource={tableData.data} isLoading={tableData.__loading} className="basic-table" style={styles.basicTable} hasBorder={false} onRowClick={onRowClick}>
              ...
              <Table.Column title="培训介绍" width={150} dataIndex="introduce"/>
              <Table.Column title="阶段说明" width={150} dataIndex="explain"/>
