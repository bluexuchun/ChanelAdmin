...
@connect(
  state=>({user:state.user,setting:state.settingDate}),
  {login}
)
...
export default class UserLogin extends Component {
  ...
  clickregister=()=>{
    console.log('111');
    this.props.history.router.push('./register');
  }
    ...
    return (
      <div style={styles.userLogin} className="user-login">
        {this.props.user.login ?
          this.props.child.router.push('/home')
          :
          null
        }
        <div
        ...
        <div style={styles.contentWrapper} className="content-wrapper">
          <h2 style={styles.slogan} className="slogan">
            欢迎使用 <br /> {this.state.righttext ? this.state.righttext : '新人培训'}管理系统
          </h2>
            ...
            >
              <div style={styles.formItems}>
                ...
                <Row className="tips" style={styles.tips}>
                  <Link to="/userregister" style={styles.link}>
                    立即注册
                  </Link>
