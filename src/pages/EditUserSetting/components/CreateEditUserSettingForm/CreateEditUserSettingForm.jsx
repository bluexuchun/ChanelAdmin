...
export default class CreateEditUserSettingForm extends Component {
  field = new Field(this);
  static displayName = 'CreateEditUserSettingForm';
        ...
        <IceFormBinderWrapper ref={(formRef) => {
          ...
          <div>
            ...
            <Row style={styles.formItem}>
              ...
              <Col s="12" l="10">
                <IceFormBinder name="Worknumber" required={true} message="标题名称必须填写">
                  <Input  style={{
                      width: '100%'
                    }}/>
                </IceFormBinder>
            ...
            <Row style={styles.formItem}>
              ...
              <Col s="12" l="10">
                <IceFormBinder name="counter" required={true} message="标题名称必须填写">
                  <Input style={{
                      width: '100%'
                    }}/>
                </IceFormBinder>
            ...
            <Row style={styles.formItem}>
              ...
              <Col s="12" l="10">
                <IceFormBinder name="city" required={false} message="城市必须填写">
                  <Input style={{
                      width: '100%'
                    }}/>
                </IceFormBinder>
                <IceFormError name="city"/>
              </Col>
            </Row>
