...
export default class SettingsForm extends Component {
  ...
  componentDidMount(){
    ...
    this.setState({
      logoImg:this.props.setting.logoImg,
      allImg:this.props.setting.commonbg,
      description:this.props.setting.description,
      value:{
        xiangmuname:this.props.setting.xiangmuname,
        xiangmudetail:this.props.setting.xiangmudetail,
         gotext:this.props.setting.gotext,
        logintext:this.props.setting.logintext,
        righttext:this.props.setting.righttext,
      }
    })
